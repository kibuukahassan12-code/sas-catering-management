...
def dashboard():
    ...
    try:
        ...
        # Clients CRM
        if has_permission("crm") or has_permission("clients"):
            modules.append({"name": "Clients CRM", "url": url_for("core.clients_list")})
        
        # Events
        if has_permission("events") or has_permission("events.view"):
            events_children = [
            ...
            if has_permission("floorplanner"):
                events_children.append({"name": "Floor Planner", "url": url_for("floorplanner.dashboard")})
            if has_permission("tasks"):
                events_children.append({"name": "Tasks", "url": url_for("tasks.task_list")})
            modules.append({
                "name": "Events",
        ...
        if has_permission("hire"):
            ...
            if has_permission("maintenance"):
                hire_children.append({"name": "Equipment Maintenance", "url": url_for("maintenance.dashboard")})
            modules.append({
